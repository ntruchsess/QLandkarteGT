...
const CMegaMenu::func_key_state_t CMegaMenu::fsMap[] =
{
    ...
    ,{0,QObject::tr("-"),0,tr("")}
    ,{":/icons/iconSelMap16x16",QObject::tr("Select Sub Map"),&CMegaMenu::funcSelectArea,tr("Select area of map to export. Select area by pressing down the left mouse button and move the mouse.")}
...
const CMegaMenu::func_key_state_t CMegaMenu::fsOverlay[] =
{
    ...
    ,{0,QObject::tr("-"),0,tr("")}//,{":/icons/iconDistance16x16",QObject::tr("Add Distance Polyline"),&CMegaMenu::funcDistance,tr("Add a polyline to measure distances.")}
    ,{0,QObject::tr("-"),0,tr("")}
    ,{0,QObject::tr("-"),0,tr("")}
    ,{0,QObject::tr("-"),0,tr("")}
    ,{0,QObject::tr("-"),0,tr("")}
