...
//{
//    public:
//        CDiaryInternalEditLock(CTextEditWidget * d) : d(d){d->isInternalEdit += 1;}
...
CTextEditWidget::CTextEditWidget(CDiary * diary, QWidget * parent, bool embedded)
: QWidget(parent)
, embedded(embedded)
, modified(false)
//, isInternalEdit(0)
...
void CTextEditWidget::setWindowModified()
{
    setWindowModified(true);
}

void CTextEditWidget::setWindowModified(bool yes)
{
...
void CTextEditWidget::slotDocWizard()
{
...
void CTextEditWidget::collectData()
{
//    quint32 cnt;
...
void CTextEditWidget::slotPrintPreview()
{
